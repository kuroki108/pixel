...
from config import MEDIA_CHANNEL_ID_1, SELFIE_CHANNEL_ID_1, VORSTELLUNG_CHANNEL_ID_1, QOTD_CHANNEL_ID

MEDIA_CHANNEL_IDS = {MEDIA_CHANNEL_ID_1, SELFIE_CHANNEL_ID_1}
TEXT_ONLY_THREAD_CHANNEL_IDS = {VORSTELLUNG_CHANNEL_ID_1, QOTD_CHANNEL_ID}
